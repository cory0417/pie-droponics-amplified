...
import { Card, ScrollView, Collection, Heading, Text } from '@aws-amplify/ui-react';
...
function TopicSubscriber ({topic}) {
  ...
  return (
    <Card
        ...
        columnEnd="5"
    >
        <Heading level='2' fontWeight='regular' fontSize="2rem">Subscriber</Heading>
        <Text>New messages from your device(s) that publish to the topic <b>{topic}</b> will appear in the box below</Text>
        <ScrollView
