...
import { createCmdLog } from "../graphql/mutations";
export default function CmdLogCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setOn_interval(initialValues.on_interval);
    setOff_interval(initialValues.off_interval);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createCmdLog.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "CmdLogCreateForm")}
      {...rest}
    >
      <TextField
        label="Target"
