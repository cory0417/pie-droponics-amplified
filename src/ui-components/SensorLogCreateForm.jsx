...
import { createSensorLog } from "../graphql/mutations";
export default function SensorLogCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setSensor_name(initialValues.sensor_name);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createSensorLog.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "SensorLogCreateForm")}
      {...rest}
    >
      <TextField
        label="Sensor name"
